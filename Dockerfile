...
RUN apk --no-cache add --virtual build-dependencies \
    ...
    curl -sSLO https:/${NODEPATH}js.org/dist/v${NODE_VERSION}${NODEPATH}-v${NODE_VERSION}.tar.xz && \
    curl -sSL https:/${NODEPATH}js.org/dist/v${NODE_VERSION}/SHASUMS256.txt.asc | \
      gpg --batch --decrypt | \
